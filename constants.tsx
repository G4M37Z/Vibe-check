...
export const ICONS = {
  ...
  WhatsApp: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-10.4 8.38 8.38 0 0 1 4.4 1.2L22 4l-1 5.1z"></path></svg>
  ),
  Twitter: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 4s-1 2.1-3 2.1c1.1.2 2 .5 3 2.5a8.8 8.8 0 0 1-6 2c-3.9 0-7-3.1-7-7 0-.3 0-.6.1-.9A10 10 0 0 1 1 3s3 2 6 2c0-1.9 1.6-3.4 3.5-3.4a3.5 3.5 0 0 1 3.1 1.9c1 0 2-.4 3-1a3.5 3.5 0 0 1-1.5 2.5z"></path></svg>
  )
};
